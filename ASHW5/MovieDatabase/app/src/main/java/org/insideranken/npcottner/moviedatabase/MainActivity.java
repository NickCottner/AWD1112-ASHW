...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<String> movie_director;
    ArrayList<String> movie_length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movie_length = new ArrayList<>();
        movie_title = new ArrayList<>();

        storeDataInArrays();

        myAdapter = new MyAdapter(MainActivity.this, this, movie_id, movie_title,
                movie_director, movie_length);
    ...
    void storeDataInArrays()
    {
        ...
        if(cursor.getCount() == 0){
            ...
            while (cursor.moveToNext()){
                ...
                movie_length.add(cursor.getString(3));
            }
