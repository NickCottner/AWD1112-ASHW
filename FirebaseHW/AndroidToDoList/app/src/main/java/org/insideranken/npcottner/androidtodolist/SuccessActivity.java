...
public class SuccessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.rvOnSuccess);
    ...
    private void updateTask() {
        ...
        final EditText mTask = view.findViewById(R.id.etUpdateTask);
        final EditText mDescription = view.findViewById(R.id.etUpdateDescription);
